...
To create your first game, start by creating a project from the [Project Dashboard](https://projects.nanoforge.eu/dashboard/projects). Click **New project** and fill the projet information.

![Create Project](../../images/create-project.png)

If you want to automatically link your project to a github repository, click **Add repositories from github** and select the organisation you want to use.
