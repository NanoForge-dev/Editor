...
<button
  class="border-0 bg-neutral-900 p-0 transition-colors duration-150 hover:bg-neutral-800 focus:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400"
